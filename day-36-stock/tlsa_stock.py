...
response =requests.get(url='https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=TSLA&apikey=')
...
if percent > 2:
    print('get news')
#news
res = requests.get(url='https://newsapi.org/v2/everything?q=tesla&from=2023-08-8&sortBy=publishedAt&apiKey=')
